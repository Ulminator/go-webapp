...
func (s1 standLocator) registerRoutes() {
	...
	http.HandleFunc("/api/stands", s1.handleApiStands)
}
...
func (s1 standLocator) handleApiStands(w http.ResponseWriter, r *http.Request) {
	dec := json.NewDecoder(r.Body)
	// Create a struct that allows capturing of zipCode field.
	var loc struct {
